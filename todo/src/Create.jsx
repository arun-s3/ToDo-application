...
function Create({ onsubmit, isModalOpen, onModalClose }) {
  ...
  const addChecklistItem = () => {
    if (checklistInput.trim()) {
      setTask({
        ...task,
        checklist: [...task.checklist, { text: checklistInput, completed: false }],
      })
      setChecklistInput("")
    }
  }
        ...
        <div className="modal-overlay" onClick={onModalClose}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <div className="modal-section">
                ...
                <div className="checklist-input-group">
                  ...
                  />
                  <button className="btn-add-item" onClick={addChecklistItem}>
                    <Plus size={16} />
                  </button>
                </div>
                <div className="checklist-items">
                  {task.checklist.map((item, idx) => (
                    <div key={idx} className="checklist-item">
                      <span>{item.text}</span>
                      <button className="btn-remove" onClick={() => removeChecklistItem(idx)}>
                        <X size={16} />
                      </button>
                    </div>
                  ))}
              ...
              <div className="modal-section">
                ...
                <div className="tag-input-group">
                  <input
                    ...
                    className="tag-input"
                  />
                  <button className="btn-add-item" onClick={addTag}>
                    <Plus size={16} />
                  </button>
                </div>
            ...
            <div className="modal-footer">
              <button className="btn-modal-cancel" onClick={onModalClose}>
                Cancel
              </button>
